...
function area1() {
    ...
    output.innerText = "the area of the triangle whose base "+base1.value+" and height "+height1.value+" is "+area;
}
...
function area2 ( ){
    ...
    output.innerText = `the area of the triangle with sides ${lengths[0].value}, ${lengths[1].value}, ${lengths[2].value} is ${area}`;
